...
export function useTweaks<T extends Record<string, string>>(defaults: T): [T, (key: keyof T, value: string) => void] {
  const [values, setValues] = useState<T>(defaults);
  const setTweak = useCallback((key: keyof T, value: string) => {
